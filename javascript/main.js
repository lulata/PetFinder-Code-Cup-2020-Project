...
function updateUI(animalInfo) {
  ...
  animalInfo.forEach(animal => {
    ...
    if (animal.photos.length > 0) {
      ...
      image = "<img src='img/noimg.png' border='0' alt='Petfinder Logo, Adopt a homeless pet' />";
      results.innerHTML += `
        <div class="card m-2 p-3">
          <div class="row">
            <div class="col-sm-6 text-center">
...
petForm.addEventListener('submit', e => {
  ...
  if (validZip.test(zip)) {
    ...
    results.innerHTML = '<div class="text-center"><div class="small"><iframe src="https://giphy.com/embed/lpOxKH3VWxTPi" width="100px" height="100px" frameBorder="0" class="giphy-embed"></iframe></div></div>';
    setTimeout(() => {
